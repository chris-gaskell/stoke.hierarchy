...
list(from = 'Gill', to = 'Callum')#,
    ...
    nodes = list(
      ...
      list(id = 'Gill',       title = CN,    name = 'Dr. Gill Cooke',                                description = "Gill.Cooke@<br>combined.nhs.uk<br>0.5WTE",            color = "lightgreen",    height = height,   width = width,   layout = 'hanging',  borderColor = 'black',    image = "https://eitrawmaterials.eu/wp-content/uploads/2016/09/person-icon.png", offset = '0%'),
      ...
      list(id = 'Cara',       title = CP,    name = 'Dr. Cara Thompson',     level = 2,              description = "Cara.Thompson@<br>combined.nhs.uk<br>0.7WTE",         color = "lightblue",    height = height,   width = width,                        borderColor = 'black',    image = "https://eitrawmaterials.eu/wp-content/uploads/2016/09/person-icon.png", offset = '-80%'),
      ...
      list(id = 'Chris',      title = CP,    name = 'Dr. Chris Gaskell',     level = 3,              description = "Christopher.Gaskell@<br>combined.nhs.uk<br>0.9WTE",   color = "red",    height = height,   width = width,                        borderColor = 'black',    image = "https://eitrawmaterials.eu/wp-content/uploads/2016/09/person-icon.png"),
